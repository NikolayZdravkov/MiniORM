...
namespace MiniORM
{
    public  class DbContext
    {
        ...
        public void Persist<TEntity>(DbSet<TEntity> dbSet) where TEntity : class, new()
        {
        ...
        private void MapRealtions<TEntity>(DbSet<TEntity> dbSet) where TEntity : class, new()
        {
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var columns = table.GetProperties().Where(pi => dbColumns.Contains(pi.Name) && !pi.HasAttribute<NotMappedAttribute>() &&
